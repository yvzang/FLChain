...
if __name__ == "__main__":
    ...
    parser.add_argument('-cn', "--client_num", type=int, default=5, help="clients number.")
    parser.add_argument('-niid', "--non_iid_number", type=int, default=2, help="non-iid dataset number.")
    parser.add_argument('-bs', "--batch_size", type=int, default=8, help="batch size.")
    parser.add_argument('-vs', "--valid_size", type=float, default=0.1, help="valid dataset size.")
    parser.add_argument('-htn', "--hete_num", type=int, default=2, help="number of heterogeneity dataset")
